...
int main()
{
   ...
   char judulbuku[11][20]={"Pendidikan Agama","Struktur Data","Sistem Operasi","Bahasa Inggris",
   							"Matematika Diskrit","Belajar Kalkulus",
                           "Logika Informatika","Sistem Basis Data",
                           "Kecakapan Personal","Bahasa Indonesia",
                           "Organisasi Komputer"};
